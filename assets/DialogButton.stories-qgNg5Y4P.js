import{a as e,n as t}from"./chunk-BneVvdWh.js";import{$ as n,l as r,ot as i,u as a}from"./iframe-BtzXbMLI.js";import{c as o,s,t as c}from"./esm-l6D_WZNr.js";import{F as l}from"./ClickAwayListener-BpaxgXpe.js";import{t as u}from"./createSvgIcon-CcXt0Srs.js";var d,f,p=t((()=>{u(),d=n(),f=l((0,d.jsx)(`path`,{d:`M15.41 7.41 14 6l-6 6 6 6 1.41-1.41L10.83 12z`}),`ChevronLeft`)})),m,h,g=t((()=>{u(),m=n(),h=l((0,m.jsx)(`path`,{d:`M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z`}),`ChevronRight`)})),_,v,y,b=t((()=>{_=e(i(),1),s(),p(),g(),r(),v=a(o)`
  min-width: 120px;
  color: white;
  font-weight: bold;
  padding: 4px 0;
...
`,y=({mode:e=`dark`,previousIcon:t,nextIcon:n,...r})=>_.createElement(v,{mode:e,startIcon:t&&_.createElement(f,null),endIcon:n&&_.createElement(h,null),...r});try{y.displayName=`DialogButton`,y.__docgenInfo={description:``,displayName:`DialogButton`,props:{}}}catch{}})),x,S,C,w,T,E,D,O,k;t((()=>{x=e(i(),1),c(),b(),S=a(`h2`)`
  color: white;
