...
var MaterialUIButton = require('@material-ui/core/Button');
...
var MaterialUIButton__default = /*#__PURE__*/_interopDefaultLegacy(MaterialUIButton);
...
var useStyles = makeStyles__default['default'](function (theme) { return ({
    root: function (_a) {
...
var Button = function (_a) {
    ...
    return (React__default['default'].createElement(MaterialUIButton__default['default'], __assign({ classes: __assign({ root: "" + localClasses.root + (root ? ' ' + root : ''), contained: "" + localClasses.contained + (contained ? ' ' + contained : ''), containedPrimary: "" + localClasses.containedPrimary + (containedPrimary ? ' ' + containedPrimary : ''), containedSecondary: "" + localClasses.containedSecondary + (containedSecondary ? ' ' + containedSecondary : '') }, otherClasses), variant: variant }, otherProps)));
};
Button.defaultProps = {
    variant: 'contained',
};

var TestButton = function (props) { return (React__default['default'].createElement(MaterialUIButton__default['default'], __assign({}, props))); };
...
var theme = createTheme__default['default']({
    palette: {
        primary: {
